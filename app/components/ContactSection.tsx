              ...
              <CardContent>
                <div className="grid grid-cols-4 gap-4">
                  ...
                  >
                    ...
                    <span className="text-xs mt-2 text-gray-600 group-hover:text-blue-600">
                      Facebook
                    </span>
                  </a>
                  ...
                  >
                    ...
                    <span className="text-xs mt-2 text-gray-600 group-hover:text-pink-600">
                      Instagram
                    </span>
                  </a>
                  ...
                  >
                    ...
                    <span className="text-xs mt-2 text-gray-600 group-hover:text-blue-700">
                      LinkedIn
                    </span>
                  </a>
                  ...
                  >
                    ...
                    <span className="text-xs mt-2 text-gray-600 group-hover:text-blue-500">
                      Telegram
                    </span>
                  </a>
                  ...
                  >
                    ...
                    <span className="text-xs mt-2 text-gray-600 group-hover:text-red-600">
                      Pinterest
                    </span>
                  </a>
                  ...
                  >
                    ...
                    <span className="text-xs mt-2 text-gray-600 group-hover:text-green-600">
                      WhatsApp
                    </span>
                  </a>
                </div>
