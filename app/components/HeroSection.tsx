  ...
  return (
    <div className="relative min-h-screen pt-24 overflow-hidden">
      ...
      <div className="absolute inset-0 bg-gradient-to-br from-amber-100 via-orange-100 to-amber-200">
        <div className="absolute inset-0 bg-gradient-to-tr from-amber-50/50 via-transparent to-orange-50/50"></div>
        <div className="absolute inset-0 bg-[radial-gradient(circle_at_top_right,_var(--tw-gradient-stops))] from-amber-300/20 via-transparent to-transparent"></div>
        <div className="absolute inset-0 bg-[radial-gradient(circle_at_bottom_left,_var(--tw-gradient-stops))] from-orange-200/30 via-transparent to-transparent"></div>
      </div>
